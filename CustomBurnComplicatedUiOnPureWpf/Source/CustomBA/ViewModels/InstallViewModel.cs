...
namespace CustomBA.ViewModels
{
    public class InstallViewModel : INotifyPropertyChanged
    {
        ...
        private readonly List<string> _innerInstallPackageIds = new List<string>
        {
            "InstallationPackage1",
            "InstallationPackage2",
            "InstallationPackage3"
        };
        ...
        public bool NotPresent
        {
            ...
            {
                _notPresent = value;
                PropertyChanged(this, new PropertyChangedEventArgs(nameof(NotPresent)));
            }
        }
            ...
            DetectPackageCompleteEventArgs e)
        {
            ...
            if (NotPresent && _innerInstallPackageIds.Contains(e.PackageId) && e.State == PackageState.Present)
            {
                NotPresent = false;
                InitUninstalViewModels();
            }
        ...
        private void InitUninstalViewModels()
        {
